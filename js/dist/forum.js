...
function addStickyControl() {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_utils_PostControls__WEBPACK_IMPORTED_MODULE_2___default()), 'controls', function (items, post) {
    var discussion = post.discussion();
    var canSticky = discussion.canStickyPosts();
    if (canSticky) {
      ...
      }, flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans(post.is_sticky() ? 'xypp-sticky-posts.forum.unsticky' : 'xypp-sticky-posts.forum.sticky')));
    }
  });
}
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (/* binding */ addStickyIcon)
/* harmony export */ });
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! flarum/forum/app */ "flarum/forum/app");
/* harmony import */ var flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(flarum_forum_app__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! flarum/common/extend */ "flarum/common/extend");
...
function addStickyIcon() {
  (0,flarum_common_extend__WEBPACK_IMPORTED_MODULE_1__.extend)((flarum_forum_components_CommentPost__WEBPACK_IMPORTED_MODULE_2___default().prototype), 'headerItems', function (items) {
    if (this.attrs.post.is_sticky()) {
      ...
      }), flarum_forum_app__WEBPACK_IMPORTED_MODULE_0___default().translator.trans('xypp-sticky-posts.forum.sticky_icon')), 80);
    }
  });
}
...
/* harmony import */ var _addStickyAction__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./addStickyAction */ "./src/forum/addStickyAction.ts");
/* harmony import */ var _addStickyIcon__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./addStickyIcon */ "./src/forum/addStickyIcon.tsx");





flarum_forum_app__WEBPACK_IMPORTED_MODULE_2___default().initializers.add('xypp/flarum-sticky-posts', function () {
  (flarum_common_models_Post__WEBPACK_IMPORTED_MODULE_1___default().prototype).is_sticky = flarum_common_models_Post__WEBPACK_IMPORTED_MODULE_1___default().attribute('is_sticky');
  (flarum_common_models_Discussion__WEBPACK_IMPORTED_MODULE_0___default().prototype).canStickyPosts = flarum_common_models_Discussion__WEBPACK_IMPORTED_MODULE_0___default().attribute('canStickyPosts');
  (0,_addStickyAction__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_addStickyIcon__WEBPACK_IMPORTED_MODULE_4__["default"])();
});
